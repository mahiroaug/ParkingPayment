...
// -------------------LIB------------------ //
const GetterEngine = require("./lib/41A_getAddr");
...
exports.handler = async (event) => {
  ...
  switch (path) {
    ...
    default:
      ...
      console.log("41A_getterRegistry::from_addr:", from_addr);
      ...
      console.log("41Q_QueueEngine::resQueue:", resQueue);
  ...
  console.log("34::responseBody:", responseBody);
